...
export default function AboutMe() {
  return (
    <>
      <div className={`overflow-hidden w-[100vw] h-[200vh] flex flex-col xl:flex-row justify-center items-center pr-18 md:pl-26 lg:pl-26 xl:h-[120vh] lg:h-auto md:h-auto p-2 z-10 gap-8 xl:gap-8`}>
